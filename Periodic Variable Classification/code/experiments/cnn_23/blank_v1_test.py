...
bins=10
os.mkdir("blank_v1_test")

x=np.load("X_test.npy")
x_global=np.load("X_test.npy")
(l,o,m,n)=x.shape
...
np.save("blank_v1_test/m_a",m_a)
np.save("blank_v1_test/w",w)
np.save("blank_v1_test/t",t)
np.save("blank_v1_test/x",x)
