...
if x_1.size!=0: # checking whether there exists a class which has no object being classified by cnn
    ...
    np.save("avg_sub_2/1_mean",one_avg)
...
if x_2.size!=0:
    ...
    np.save("avg_sub_2/2_mean",two_avg)
...
if x_4.size!=0:
    ...
    np.save("avg_sub_2/4_mean",four_avg)
...
if x_5.size!=0:
    ...
    np.save("avg_sub_2/5_mean",five_avg)
...
if x_6.size!=0:
    ...
    np.save("avg_sub_2/6_mean",six_avg)
...
if x_8.size!=0:
    ...
    np.save("avg_sub_2/8_mean",eight_avg)
...
if x_13.size!=0:
    ...
    np.save("avg_sub_2/13_mean",thirteen_avg)
...
if len(one[0])!=0:# checking whether there exists a class which has no object being classified by cnn
    ...
    np.save("avg_sub_2/m_1_mean",m_1_avg)
if len(two[0])!=0:
    m_2_avg=m_2/len(two[0])
    np.save("avg_sub_2/m_2_mean",m_2_avg)
if len(four[0])!=0:
    m_4_avg=m_4/len(four[0])
    np.save("avg_sub_2/m_4_mean",m_4_avg)
if len(five[0])!=0:
    m_5_avg=m_5/len(five[0])
    np.save("avg_sub_2/m_5_mean",m_5_avg)
if len(six[0])!=0:
    m_6_avg=m_6/len(six[0])
    np.save("avg_sub_2/m_6_mean",m_6_avg)
if len(eight[0])!=0:
    m_8_avg=m_8/len(eight[0])
    np.save("avg_sub_2/m_8_mean",m_8_avg)
if len(thirteen[0])!=0:
    m_13_avg=m_13/len(thirteen[0])
    np.save("avg_sub_2/m_13_mean",m_13_avg)
...
if len(one[0])!=0:
    ...
    im1=ax[0].imshow(one_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_1_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    ...
    plt.savefig("avg_sub_2/1_mean_heatmap.png")
    plt.close()

if len(two[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(two_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_2_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/2_mean_heatmap.png")
    plt.close()

if len(four[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(four_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_4_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/4_mean_heatmap.png")
    plt.close()
    
if len(five[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(five_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_5_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/5_mean_heatmap.png")
    plt.close()

if len(six[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(six_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_6_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/6_mean_heatmap.png")
    plt.close()

if len(eight[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(eight_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_8_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/8_mean_heatmap.png")
    plt.close()
    
if len(thirteen[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(thirteen_avg.reshape((23,24)),vmin=0,vmax=30,cmap="Paired")
    im2=ax[1].imshow(m_13_avg,vmin=-0.6,vmax=0.04,cmap="Paired_r")
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_2/13_mean_heatmap.png")
    plt.close()
