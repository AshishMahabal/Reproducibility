...
np.save("avg_sub_test/x_1",x_1)
np.save("avg_sub_test/x_2",x_2)
np.save("avg_sub_test/x_4",x_4)
np.save("avg_sub_test/x_5",x_5)
np.save("avg_sub_test/x_6",x_6)
np.save("avg_sub_test/x_8",x_8)
np.save("avg_sub_test/x_13",x_13)
...
if x_1.size!=0: # checking whether there exists a class which has no object being classified by cnn
    ...
    np.save("avg_sub_test/1_mean",one_avg)
...
if x_2.size!=0:
    ...
    np.save("avg_sub_test/2_mean",two_avg)
...
if x_4.size!=0:
    ...
    np.save("avg_sub_test/4_mean",four_avg)
...
if x_5.size!=0:
    ...
    np.save("avg_sub_test/5_mean",five_avg)
...
if x_6.size!=0:
    ...
    np.save("avg_sub_test/6_mean",six_avg)
...
if x_8.size!=0:
    ...
    np.save("avg_sub_test/8_mean",eight_avg)
...
if x_13.size!=0:
    ...
    np.save("avg_sub_test/13_mean",thirteen_avg)
...
if len(one[0])!=0:# checking whether there exists a class which has no object being classified by cnn
    ...
    np.save("avg_sub_test/m_1_mean",m_1_avg)
if len(two[0])!=0:
    m_2_avg=m_2/len(two[0])
    np.save("avg_sub_test/m_2_mean",m_2_avg)
if len(four[0])!=0:
    m_4_avg=m_4/len(four[0])
    np.save("avg_sub_test/m_4_mean",m_4_avg)
if len(five[0])!=0:
    m_5_avg=m_5/len(five[0])
    np.save("avg_sub_test/m_5_mean",m_5_avg)
if len(six[0])!=0:
    m_6_avg=m_6/len(six[0])
    np.save("avg_sub_test/m_6_mean",m_6_avg)
if len(eight[0])!=0:
    m_8_avg=m_8/len(eight[0])
    np.save("avg_sub_test/m_8_mean",m_8_avg)
if len(thirteen[0])!=0:
    m_13_avg=m_13/len(thirteen[0])
    np.save("avg_sub_test/m_13_mean",m_13_avg)
...
if len(one[0])!=0:
    ...
    im1=ax[0].imshow(one_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_1_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    ...
    plt.savefig("avg_sub_test/1_mean_heatmap.png")
    plt.close()

if len(two[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(two_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_2_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    ax[0].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[1].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[0].set_title("Averaged dmdt for class2 EA ("+str(x_2.shape[0])+")"+"\nMin: "+str(round(two_avg.min(),5))+" Violet"+"\n Max: "+str(round(two_avg.max(),5))+" Yellow")
    ax[1].set_title("Averaged Change\n in Probabilities\n Min: "+str(round(m_2_avg.min(),5))+" Violet"+"\n Max: "+str(round(m_2_avg.max(),5))+" Yellow")
    fig.colorbar(im1,cax=cax1)
    fig.colorbar(im2,cax=cax2)
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_test/2_mean_heatmap.png")
    plt.close()

if len(four[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(four_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_4_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    ax[0].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[1].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[0].set_title("Averaged dmdt for class4 RRab ("+str(x_4.shape[0])+")"+"\nMin: "+str(round(four_avg.min(),5))+" Violet"+"\n Max: "+str(round(four_avg.max(),5))+" Yellow")
    ax[1].set_title("Averaged Change\n in Probabilities\n Min: "+str(round(m_4_avg.min(),5))+" Violet"+"\n Max: "+str(round(m_4_avg.max(),5))+" Yellow")
    fig.colorbar(im1,cax=cax1)
    fig.colorbar(im2,cax=cax2)
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_test/4_mean_heatmap.png")
    plt.close()
    
if len(five[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(five_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_5_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    ax[0].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[1].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[0].set_title("Averaged dmdt for class5 RRc ("+str(x_5.shape[0])+")"+"\nMin: "+str(round(five_avg.min(),5))+" Violet"+"\n Max: "+str(round(five_avg.max(),5))+" Yellow")
    ax[1].set_title("Averaged Change\n in Probabilities\n Min: "+str(round(m_5_avg.min(),5))+" Violet"+"\n Max: "+str(round(m_5_avg.max(),5))+" Yellow")
    fig.colorbar(im1,cax=cax1)
    fig.colorbar(im2,cax=cax2)
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_test/5_mean_heatmap.png")
    plt.close()

if len(six[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(six_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_6_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    ax[0].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[1].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[0].set_title("Averaged dmdt for class6 RRd ("+str(x_6.shape[0])+")"+"\nMin: "+str(round(six_avg.min(),5))+" Violet"+"\n Max: "+str(round(six_avg.max(),5))+" Yellow")
    ax[1].set_title("Averaged Change\n in Probabilities\n Min: "+str(round(m_6_avg.min(),5))+" Violet"+"\n Max: "+str(round(m_6_avg.max(),5))+" Yellow")
    fig.colorbar(im1,cax=cax1)
    fig.colorbar(im2,cax=cax2)
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_test/6_mean_heatmap.png")
    plt.close()

if len(eight[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(eight_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_8_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
    ...
    ax[0].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[1].set(xlabel="dt(days)",ylabel="dm(mag)")
    ax[0].set_title("Averaged dmdt for class8 RSCVn ("+str(x_8.shape[0])+")"+"\nMin: "+str(round(eight_avg.min(),5))+" Violet"+"\n Max: "+str(round(eight_avg.max(),5))+" Yellow")
    ax[1].set_title("Averaged Change\n in Probabilities\n Min: "+str(round(m_8_avg.min(),5))+" Violet"+"\n Max: "+str(round(m_8_avg.max(),5))+" Yellow")
    fig.colorbar(im1,cax=cax1)
    fig.colorbar(im2,cax=cax2)
    plt.tight_layout()
    #plt.ticks.set_xspacing(0.0005*mul)
    plt.savefig("avg_sub_test/8_mean_heatmap.png")
    plt.close()
    
if len(thirteen[0])!=0:
    fig,ax=plt.subplots(1,2)
    im1=ax[0].imshow(thirteen_avg.reshape((23,24)),vmin=0,vmax=30,cmap=incmap)
    im2=ax[1].imshow(m_13_avg,vmin=-0.6,vmax=0.2,cmap=icmap)
    divider1 = make_axes_locatable(ax[0])
    cax1 = divider1.append_axes("right", size="5%", pad=0.1)
    divider2 = make_axes_locatable(ax[1])
    cax2 = divider2.append_axes("right", size="5%", pad=0.1)
