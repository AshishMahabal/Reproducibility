# the following keras visualization was done for Periodic CNN, however if the same needs to be done for any other CNN, then 
# several parameters need to be changed hence it would be best to use keras_vis_v3.ipynb jupyter notrebook as several trials and errors
# would be neededto change the aforementioned parameters
